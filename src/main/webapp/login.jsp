<%@page import="com.webside.util.ResourceUtil"%>
...
<head>
<title><%=ResourceUtil.getTitle() %></title>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="<%=ResourceUtil.getKeyWords() %>" />
<meta name="description" content="<%=ResourceUtil.getDescription() %>" />
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="icon-leaf ace-icon  green"></i> <span class="white"><%=ResourceUtil.getTitle() %><br>
									<%=ResourceUtil.getVersion() %></span>
							</h1>
						</div>
