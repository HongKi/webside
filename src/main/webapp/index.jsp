		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> <small> <i
						class="fa fa-leaf"></i>&nbsp;<%=ResourceUtil.getTitle() %>
				</small>
				</a>
				...
				<ul class="nav ace-nav">
					<li class="green">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								...
								<span class="badge badge-success red">1</span>
							</a>
									...
									<ul class="dropdown-menu dropdown-navbar">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="${ctx}/resources/images/user.jpg" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">姜斌:</span>
														大平台的处理意见是  ...
													</span>
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder"><%=ResourceUtil.getTitle() %></span>
						<%=ResourceUtil.getVersion() %> &copy; 2016
